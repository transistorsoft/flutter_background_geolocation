...
const EVENT_CHANNEL_CONNECTIVITYCHANGE =
    "$PLUGIN_PATH/events/connectivitychange";
...
class BackgroundGeolocation {
  ...
  static bool removeListener(Function callback) {
    Subscription found = _subscriptions.firstWhere(
        (Subscription item) => item.callback == callback,
        orElse: () => null);
    if (found != null) {
