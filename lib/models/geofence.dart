...
class Geofence {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (this.notifyOnEntry != null) params['notifyOnEntry'] = this.notifyOnEntry;
    if (this.notifyOnExit != null) params['notifyOnExit'] = this.notifyOnExit;
    if (this.notifyOnDwell != null) params['notifyOnDwell'] = this.notifyOnDwell;
    if (this.loiteringDelay != null) params['loiteringDelay'] = this.loiteringDelay;
