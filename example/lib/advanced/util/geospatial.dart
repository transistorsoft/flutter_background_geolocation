...
///
class Geospatial {
  static LatLng computeOffsetCoordinate(LatLng coordinate, double distance, double heading) {
    ...
    double lat2 = asin(sin(lat1) * cos(distance) + cos(lat1) * sin(distance) * cos(heading));
