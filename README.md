...
> [!IMPORTANT]
> This is **`v5`**. For the previous version see [`v4.x`](https://github.com/transistorsoft/flutter_background_geolocation/tree/4.18.3). **`v4.x`** license keys do **not** work with **`v5`** — log in to the [Customer Dashboard](https://transistorsoft.com) to generate a **`v5`** key. See the [Migration Guide](help/MIGRATION-GUIDE-5.0.0.md) for details.
